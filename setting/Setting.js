...
function (
    ...
    setConfig: function (config) {
        ...
        this._modificareInListaDeLayere(null, this._selectLayers);
    ...
    _modificareInListaDeLayere: function (ev, select) {
    ...
    _listaLayere: function () {
        ...
        select.onchange = lang.hitch(this, function (ev) {
            this._modificareInListaDeLayere(ev, select)
        });
        ...
        dojo.forEach(this.map.graphicsLayerIds, lang.hitch(this, function (layerId) {
            ...
            if (layer.url !== null)
                this.urlFeatureLayer.innerHTML = layer.url;
